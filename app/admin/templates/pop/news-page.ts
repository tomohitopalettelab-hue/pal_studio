  ...
  <div class="min-h-screen font-sans text-slate-900 bg-[#fff7fb]">
    ...
    <main class="max-w-5xl mx-auto px-6 py-12 space-y-10 pb-16">
      <section id="top" class="space-y-4">
        ...
        <p class="text-sm text-pink-500">リード文がここに入ります。</p>
      </section>
      <section id="concept" class="space-y-4">
        <h3 class="text-lg font-bold">本文</h3>
        <p class="text-sm text-pink-500">本文テキストがここに入ります。</p>
        <p class="text-sm text-pink-500">続きの本文テキストがここに入ります。</p>
      </section>
      <section id="features" class="space-y-3">
        <h3 class="text-lg font-bold">関連情報</h3>
        <p class="text-sm text-pink-500">関連する情報を記載します。</p>
      </section>
      ...
      <section id="works" class="space-y-3">
        ...
        <p class="text-sm text-pink-500">次回の案内を記載します。</p>
      </section>
      <section id="company" class="space-y-3">
        <h3 class="text-lg font-bold">お問い合わせ</h3>
        <p class="text-sm text-pink-500">ニュースに関する問い合わせ先を記載します。</p>
      </section>
    </main>
  </div>
</div>
