  ...
  <div class="min-h-screen font-sans text-[var(--text-color)] bg-[var(--bg-color)] relative selection:bg-[var(--main-color)] selection:text-white" style="background-image: radial-gradient(var(--sub-color) 1px, transparent 1px); background-size: 40px 40px; background-attachment: fixed; background-color: var(--bg-color); opacity: 1;">
    ...
    <header class="p-6 sticky top-0 z-[100]">
      <div class="max-w-6xl mx-auto flex items-center justify-between gap-4">
        <div class="bg-white px-6 py-3 rounded-2xl border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center gap-6">
          <div class="font-black text-[var(--main-color)] text-2xl tracking-tighter uppercase leading-none">Blog <span class="text-[var(--sub-color)]">Detail</span></div>
        </div>
        <a href="/blog" class="bg-[var(--main-color)] text-white px-6 py-3 rounded-2xl border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-xs font-black uppercase hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all">Back to List</a>
      </div>
    </header>
    ...
    <main class="max-w-4xl mx-auto px-6 py-20 space-y-16">
      <section id="top" class="bg-white p-10 md:p-16 rounded-[3rem] border-[4px] border-black shadow-[12px_12px_0px_0px_var(--main-color)] relative">
        <div class="absolute -top-6 -left-6 bg-[var(--accent-color)] p-4 rounded-full border-[3px] border-black font-black shadow-[4px_4px_0px_0px_#000] rotate-12 text-2xl">✨</div>
        ...
        <h1 class="text-3xl md:text-5xl font-black mb-8 leading-tight">ブログタイトルが入ります</h1>
        <p class="font-black text-slate-500 text-lg leading-relaxed">リード文がここに入ります。この記事で伝えたい一番ワクワクすることを書きましょう！</p>
      </section>
      ...
      <section id="service" class="bg-white p-10 rounded-[3rem] border-[4px] border-black shadow-[12px_12px_0px_0px_var(--main-color)]">
        <h3 class="text-2xl font-black mb-8 border-b-[4px] border-black pb-4 inline-block">他のブログ</h3>
      ...
      <section id="company" class="bg-[var(--main-color)] text-white p-10 rounded-[3rem] border-[4px] border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] text-center">
        ...
        <p class="font-black text-white/90 leading-relaxed mb-6">ブログに関する問い合わせ先を記載します。</p>
