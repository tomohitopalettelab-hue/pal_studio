...
export const naturalContactTemplate: TemplateVariant = {
  id: 'variant-natural-contact',
  templateId: 'template-natural',
  name: 'Contact',
  pageSlug: 'contact',
  description: 'Natural / Contact page layout',
  html: `
