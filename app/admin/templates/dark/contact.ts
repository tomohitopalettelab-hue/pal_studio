...
export const darkContactTemplate: TemplateVariant = {
  id: 'variant-dark-contact',
  templateId: 'template-dark',
  name: 'Contact',
  pageSlug: 'contact',
  description: 'Dark / Contact page layout',
  html: `
