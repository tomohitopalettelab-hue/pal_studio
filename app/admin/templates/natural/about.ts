...
export const naturalAboutTemplate: TemplateVariant = {
  id: 'variant-natural-about',
  templateId: 'template-natural',
  name: 'About',
  pageSlug: 'about',
  description: 'Natural / About page layout',
  html: `
  ...
  <div class="min-h-screen font-sans text-slate-900 bg-[#f7fdf7]">
    ...
    <main class="max-w-5xl mx-auto px-6 py-12 space-y-10 pb-16">
      <section id="top" class="space-y-4">
        ...
        <p class="text-sm text-emerald-600">価値ある体験を提供するための指針を記載します。</p>
      </section>
      <section id="concept" class="space-y-3">
        <h3 class="text-lg font-bold">コンセプト</h3>
        <p class="text-sm text-emerald-600">ブランドの世界観や考え方を記載します。</p>
      </section>
      <section id="features" class="space-y-3">
        <h3 class="text-lg font-bold">特徴</h3>
        <ul class="space-y-2 text-sm text-emerald-600">
          <li>・サービスの強みを記載</li>
          <li>・品質や姿勢を記載</li>
          <li>・独自性を記載</li>
        </ul>
      ...
      <section id="service" class="space-y-3">
        ...
        <p class="text-sm text-emerald-600">提供する価値や体験を記載します。</p>
      </section>
      <section id="works" class="space-y-3">
        <h3 class="text-lg font-bold">実績</h3>
        <p class="text-sm text-emerald-600">代表的な実績や事例を記載します。</p>
      </section>
      <section id="company" class="space-y-3">
        <h3 class="text-lg font-bold">会社情報</h3>
        <p class="text-sm text-emerald-600">所在地や連絡先の概要を記載します。</p>
      </section>
    </main>
  </div>
</div>
