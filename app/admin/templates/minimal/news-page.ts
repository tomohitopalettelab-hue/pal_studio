...
export const minimalNewsPageTemplate: TemplateVariant = {
  id: 'variant-minimal-news-page',
  templateId: 'template-minimal',
  name: 'News Detail',
  pageSlug: 'news-page',
  description: 'Minimal / News detail layout',
  html: `
<div class="template-root" style="--accent-color: #0f172a;">
  <div class="min-h-screen font-sans text-slate-900 bg-white">
    <header class="px-8 py-10 border-b border-slate-200 relative overflow-hidden">
      ...
      <p class="text-sm text-slate-500 mt-3">ミニマルな構成で確認できるプレビューです。</p>
    ...
    <main class="max-w-5xl mx-auto px-6 py-12 space-y-10 pb-16">
      ...
      <section id="company" class="space-y-3">
        ...
        <p class="text-sm text-slate-600">ニュースに関する問い合わせ先を記載します。</p>
      </section>
    </main>
  </div>
</div>
