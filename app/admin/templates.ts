...
<div class="template-root" style="--main-color: #000000; --main-dark: #1a1a1a; --accent-color: #6366f1; --text-color: #0a0a0a; --text-light: #666666; --bg-color: #ffffff; --section-gap: 10rem;">
  ...
  },
  {
    ...
    html: `
<div class="template-root" style="--main-color: #1a1a1a; --sub-color: #8c764b; --accent-color: #fdfbf7; --text-color: #2d2d2d; --text-light: #7a7a7a; --bg-color: #fdfbf7; --section-padding: 7rem;">
  ...
  <div class="min-h-screen font-serif text-[var(--text-color)] bg-[var(--bg-color)] selection:bg-[#c4b393] selection:text-white antialiased" style="font-family: 'Cormorant Garamond', 'Noto Serif JP', serif;">
    
    <header class="fixed top-0 w-full z-50 bg-[var(--bg-color)]/90 backdrop-blur-md border-b border-black/[0.05]">
      <div class="max-w-7xl mx-auto px-8 h-20 flex justify-between items-center">
        <nav class="hidden md:flex gap-10 text-[10px] uppercase tracking-[0.3em] font-light">
        ...
        <div class="text-xl tracking-[0.4em] uppercase font-light text-[var(--main-color)]">
          The <span class="font-normal italic">Luxury</span>
        </div>
        <div class="hidden md:flex gap-10 items-center">
          <a href="#contact" class="text-[10px] uppercase tracking-[0.3em] border-b border-[var(--sub-color)] pb-0.5">Reservation</a>
        </div>
      </div>
    </header>

    <main>
      <section id="top" class="relative min-h-[90vh] flex items-center justify-center px-6 overflow-hidden">
        <div class="absolute inset-0 z-0 opacity-40">
           <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-[var(--sub-color)]/10 rounded-full blur-[100px]"></div>
        </div>
        <div class="relative z-10 text-center">
          <p class="text-[10px] tracking-[0.6em] mb-10 uppercase text-[var(--sub-color)]">Est. 2026 — Ginza, Tokyo</p>
          <h2 class="text-6xl md:text-8xl font-extralight tracking-tighter mb-10 leading-tight text-[var(--main-color)]">
            <span class="italic">Elegant</span> <br/> Experience
          </h2>
          <p class="text-sm tracking-[0.2em] text-[var(--text-light)] max-w-md mx-auto leading-loose">
            伝統と革新が交差する場所。<br/>
            あなただけの物語を、ここから。
          </p>
          <div class="w-px h-16 bg-[var(--sub-color)] mx-auto mt-12"></div>
        </div>
      </section>

      <section id="concept" class="py-[var(--section-padding)] px-6 border-y border-black/[0.03] bg-white/40">
        <div class="max-w-4xl mx-auto text-center">
          <h3 class="text-[10px] tracking-[0.4em] mb-12 text-[var(--sub-color)] uppercase">Our Philosophy</h3>
          <p class="text-2xl md:text-3xl font-light leading-[2] text-[var(--text-color)]">
            「静寂」と「美しさ」の調和を追求し、<br/>
      ...
      <section id="features" class="py-[var(--section-padding)] px-8 max-w-7xl mx-auto">
        <div class="grid md:grid-cols-3 gap-12">
          <div class="p-8 border border-black/[0.03] bg-white/50 group hover:bg-white hover:shadow-xl transition-all duration-500">
            <span class="text-[var(--sub-color)] text-xs mb-6 block italic">01 /</span>
            <h4 class="text-xl mb-6 italic tracking-wide">Material</h4>
            <p class="text-[13px] leading-loose text-[var(--text-light)]">世界各地から厳選された最高級の素材。その本質を活かす最適解を選び抜きます。</p>
          </div>
          <div class="p-8 border border-black/[0.03] bg-white/50 group hover:bg-white hover:shadow-xl transition-all duration-500">
            <span class="text-[var(--sub-color)] text-xs mb-6 block italic">02 /</span>
            <h4 class="text-xl mb-6 italic tracking-wide">Craftsmanship</h4>
            <p class="text-[13px] leading-loose text-[var(--text-light)]">熟練の職人技。機械では到達できない、細部への祈りにも似たこだわりを宿します。</p>
          </div>
          <div class="p-8 border border-black/[0.03] bg-white/50 group hover:bg-white hover:shadow-xl transition-all duration-500">
            <span class="text-[var(--sub-color)] text-xs mb-6 block italic">03 /</span>
            <h4 class="text-xl mb-6 italic tracking-wide">Concierge</h4>
            <p class="text-[13px] leading-loose text-[var(--text-light)]">お客様一人ひとりのライフスタイルに深く寄り添い、特別な体験をご提案します。</p>
          </div>
        </div>
      </section>

      <section id="service" class="py-[var(--section-padding)] px-6 bg-[var(--main-color)] text-white text-center">
        <div class="max-w-2xl mx-auto py-16 border border-white/10 relative">
          <div class="absolute -top-3 left-1/2 -translate-x-1/2 bg-[var(--main-color)] px-4">
            <span class="text-[9px] tracking-[0.4em] uppercase text-[var(--sub-color)]">Invitation Only</span>
          </div>
          <h3 class="text-4xl font-extralight italic tracking-tighter mb-6">Art of Living Suite</h3>
          <p class="text-2xl font-thin tracking-widest text-[var(--sub-color)] mb-10">¥1,000,000 <span class="text-[10px] text-white/40 tracking-normal italic">/ year</span></p>
          <button class="px-10 py-4 border border-white/20 text-[9px] tracking-[0.4em] uppercase hover:bg-white hover:text-[var(--main-color)] transition-all">Request Access</button>
        </div>
      </section>

      <section id="works" class="py-[var(--section-padding)] px-6">
        <div class="max-w-6xl mx-auto">
          <div class="flex justify-between items-end mb-12">
            <h3 class="text-3xl font-extralight italic">Selected Collection</h3>
            <span class="text-[9px] tracking-[0.3em] text-[var(--text-light)] uppercase">View All</span>
          </div>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="aspect-[16/10] bg-stone-100 relative group overflow-hidden border border-black/5">
               <div class="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
            <div class="aspect-[16/10] bg-stone-200 relative group overflow-hidden border border-black/5">
               <div class="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
          </div>
        </div>
      ...
      <section id="company" class="py-[var(--section-padding)] px-10 max-w-5xl mx-auto border-t border-black/[0.05]">
        <div class="grid md:grid-cols-2 gap-16">
          <div>
            <h3 class="text-2xl font-light italic mb-6">Information</h3>
            <p class="text-sm text-[var(--text-light)] leading-relaxed font-light">
              特別なリクエストや、より深い体験へのご相談は、<br/>コンシェルジュまでお気軽にお寄せください。
            </p>
          </div>
          <div class="space-y-8">
            <div class="flex justify-between items-baseline border-b border-black/[0.03] pb-4">
              <span class="text-[9px] uppercase tracking-widest text-[var(--sub-color)]">Office</span>
              <span class="text-sm">Ginza, Tokyo</span>
            </div>
            <div class="flex justify-between items-baseline border-b border-black/[0.03] pb-4">
              <span class="text-[9px] uppercase tracking-widest text-[var(--sub-color)]">Email</span>
              <span class="text-sm">concierge@theluxury.jp</span>
            </div>
          </div>
        </div>
      </section>
    ...
    <footer class="py-16 bg-white border-t border-black/[0.03] text-center">
      <div class="text-[12px] tracking-[0.6em] uppercase text-[var(--main-color)] mb-6 font-light">The Luxury</div>
      <p class="text-[8px] tracking-[0.2em] text-slate-400 font-light">&copy; 2026 THE LUXURY BRAND. ALL RIGHTS RESERVED.</p>
    </footer>
  </div>
</div>`
  }
