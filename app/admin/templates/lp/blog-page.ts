...
export const lpBlogPageTemplate: TemplateVariant = {
  id: 'variant-lp-blog-page',
  templateId: 'template-lp',
  name: 'Blog Detail',
  pageSlug: 'blog-page',
  description: 'LP / Blog detail layout',
  html: `
<div class="template-root" style="--accent-color: #0ea5e9;">
  <div class="min-h-screen font-sans text-slate-900 bg-white">
    <header class="px-8 py-10 border-b border-slate-200 relative overflow-hidden">
      ...
      <p class="text-sm text-slate-500 mt-3">訴求導線を意識したプレビューです。</p>
