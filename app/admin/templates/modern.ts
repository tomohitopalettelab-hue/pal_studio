  ...
  <div class="min-h-screen font-sans text-[var(--text-color)] bg-[var(--bg-color)] selection:bg-[var(--accent-color)] selection:text-white antialiased leading-relaxed">
    ...
    <header class="fixed w-full z-[100] transition-all duration-700 bg-[var(--bg-color)]/80 backdrop-blur-xl border-b border-black/[0.03]">
      <div class="max-w-[1600px] mx-auto px-6 md:px-10 h-20 md:h-24 flex items-center justify-between">
        ...
        <nav data-sync="site-pages" class="hidden lg:flex items-center gap-8 text-[10px] font-bold uppercase tracking-[0.4em] text-[var(--text-color)]">
          <a href="#concept" class="hover:text-[var(--accent-color)] transition-colors">Concept</a>
          <a href="#service" class="hover:text-[var(--accent-color)] transition-colors">Service</a>
          <a href="#works" class="hover:text-[var(--accent-color)] transition-colors">Works</a>
          <a href="#news" class="hover:text-[var(--accent-color)] transition-colors">News</a>
          <a href="#blog" class="hover:text-[var(--accent-color)] transition-colors">Blog</a>
          <a href="#company" class="px-8 py-4 bg-[var(--main-color)] text-white text-[9px] hover:bg-[var(--accent-color)] transition-all shadow-xl shadow-black/5">Get in touch</a>
        </nav>
      ...
      <div class="fixed inset-0 bg-[var(--main-dark)] translate-x-full peer-checked:translate-x-0 transition-transform duration-500 ease-in-out lg:hidden z-[105] flex flex-col items-center justify-center">
        <nav class="flex flex-col items-center gap-8 text-white text-xs font-bold uppercase tracking-[0.5em]">
          <a href="#concept" onclick="document.getElementById('menu-toggle').checked=false">Concept</a>
          <a href="#service" onclick="document.getElementById('menu-toggle').checked=false">Service</a>
          <a href="#works" onclick="document.getElementById('menu-toggle').checked=false">Works</a>
          <a href="#news" onclick="document.getElementById('menu-toggle').checked=false">News</a>
          <a href="#blog" onclick="document.getElementById('menu-toggle').checked=false">Blog</a>
          <a href="#company" class="mt-4 px-10 py-5 bg-[var(--accent-color)]" onclick="document.getElementById('menu-toggle').checked=false">Get in touch</a>
        </nav>
      </div>
    </header>
