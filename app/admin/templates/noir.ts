...
(function() {
  ...
  // TOPページ用ブログセクション（worksデザイン、マーキーなし）
  topBlogSectionTemplate: `<section id="works" class="works" style="padding:160px 0;background:var(--color-bg,#fff);"><div class="works__inner" style="max-width:100%;margin:0 auto;padding:0 40px;"><div class="works__header" style="display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:72px;"><div><p class="works__label" style="font-family:'Cormorant Garamond',serif;font-size:0.9rem;font-weight:300;color:#999;margin-bottom:12px;">ブログ</p><h2 class="works__title" style="font-family:'Cormorant Garamond',serif;font-size:clamp(2.5rem,5vw,4rem);font-weight:300;letter-spacing:-0.02em;">最新の<br>記事</h2></div><a href="{{blogListHref}}" class="works__more" style="font-family:'Cormorant Garamond',serif;font-size:0.8rem;letter-spacing:0.08em;border-bottom:1px solid #e5e5e5;padding-bottom:4px;text-decoration:none;color:inherit;">すべての記事を見る</a></div><div class="works__grid" style="display:grid;grid-template-columns:repeat(2,1fr);gap:40px 32px;margin-bottom:64px;">{{items}}</div><div style="text-align:center;"><a href="{{blogListHref}}" class="u-btn" style="display:inline-flex;align-items:center;gap:16px;font-family:'Cormorant Garamond',serif;font-size:0.95rem;padding:14px 32px;border:1px solid #e5e5e5;transition:all 0.4s;color:#1a1a1a;text-decoration:none;">View All Posts <span>→</span></a></div></div></section>`,
  footerDefaults: {
