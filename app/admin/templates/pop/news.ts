    ...
    <header class="p-6 sticky top-0 z-[100]">
      <div class="max-w-6xl mx-auto flex items-center justify-between gap-4">
        <div class="bg-white px-6 py-3 rounded-2xl border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center gap-6">
          <div class="font-black text-[var(--main-color)] text-2xl tracking-tighter uppercase leading-none">News <span class="text-[var(--sub-color)]">List</span></div>
        </div>
    ...
    <main class="max-w-5xl mx-auto px-6 py-20">
      <div class="text-center mb-16 relative">
        <div class="inline-block bg-[var(--accent-color)] px-8 py-4 rounded-[2rem] border-[4px] border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rotate-2">
          <h1 class="text-4xl md:text-5xl font-black uppercase tracking-tighter">Latest News!</h1>
        </div>
      </div>
      
      <section id="top" class="grid gap-8 md:grid-cols-2">
        <a href="/news/news-page" class="group bg-white p-8 rounded-[3rem] border-[4px] border-black shadow-[10px_10px_0px_0px_var(--main-color)] hover:translate-x-1 hover:translate-y-1 hover:shadow-[0px_0px_0px_0px_var(--main-color)] transition-all block">
          ...
          <h2 class="text-2xl font-black mb-4 group-hover:text-[var(--main-color)] transition-colors line-clamp-2">ニュースタイトルが入ります</h2>
          <p class="font-black text-slate-500 text-sm leading-relaxed mb-6">概要テキストがここに入ります。最新のワクワク情報をお届け！</p>
        ...
        <a href="/news/news-page" class="group bg-white p-8 rounded-[3rem] border-[4px] border-black shadow-[10px_10px_0px_0px_var(--sub-color)] hover:translate-x-1 hover:translate-y-1 hover:shadow-[0px_0px_0px_0px_var(--sub-color)] transition-all block -rotate-1">
          ...
          <p class="font-black text-slate-500 text-sm leading-relaxed mb-6">お知らせの概要が入ります。お見逃しなく！</p>
